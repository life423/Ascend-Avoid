/**
 * Obstacle class representing an obstacle entity in the game.
 * Moved from root to objects/ directory for better organization.
 */
import { GAME, OBSTACLE } from '/js/shared/constants/gameConstants.js';
import { randomIntFromInterval, SCALE_FACTOR, BASE_CANVAS_WIDTH, BASE_CANVAS_HEIGHT } from '/js/utils/utils.js';
...
export default class Obstacle {
     ...
     * @param {Obstacle} otherObstacle - The other obstacle to check against
     * @returns {boolean} Whether the obstacles overlap
     */
     ...
     * @returns {boolean} Whether the obstacle is too close to player spawn
     */
     ...
     * @param {Array<Obstacle>} obstacles - Other obstacles to check for overlap
     */
